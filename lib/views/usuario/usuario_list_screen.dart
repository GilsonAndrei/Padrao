...
class _UsuarioListScreenState extends State<UsuarioListScreen> {
  ...
  void _onSearchChanged(String value) {
    ...
    // Se a busca foi limpa, recarrega a lista completa
    if (value.isEmpty) {
      _loadUsuarios();
    }
  }
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Indicador de carregamento e informações de paginação
        ...
        children: [
          Text(
            _searchQuery.isNotEmpty
                ...
                : '${users.length} de ${controller.totalItems} usuário(s) carregado(s)',
            style: TextStyle(
              color: AppColors.textSecondary,
              fontSize: 14,
              fontWeight: FontWeight.w500,
  ...
  // Na _buildUserCard, atualize a parte do telefone e foto:
  ...
  // Adicione este método auxiliar para formatar último acesso
